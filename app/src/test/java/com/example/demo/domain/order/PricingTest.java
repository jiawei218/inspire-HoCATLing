...
public class PricingTest {
  ...
  void order_should_calculate_correct_price_when_have_a_discount_and_meet_threshold_amount() {
    FullReductionDiscount discount = new FullReductionDiscount(DiscountType.FULL_REDUCTION, new BigDecimal("50"),
        new BigDecimal("5"));
    ...
    assertThat(pricing.finalAmount()).isEqualByComparingTo(new BigDecimal("54.00"));
