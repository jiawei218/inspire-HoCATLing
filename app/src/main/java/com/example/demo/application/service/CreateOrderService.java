...
public class CreateOrderService {
        ...
        public record CreateOrderCommand(
                        ...
                        @Valid DiscountParaDto discountPara) {
                public record DiscountParaDto(
                                @NotNull DiscountType type,
                                @NotNull @Min(0) BigDecimal threshold,
        ...
        public record CreateOrderResult(
                ...
                public record PricingDto(
                                ...
                                BigDecimal finalAmount, DiscountInfoDto discountInfo) {
                }
        ...
        public CreateOrderResult createOrder(CreateOrderCommand command) {
                ...
                List<OrderItem> items = command.items().stream()
                                .map(dto -> new OrderItem(new DishId(dto.dishId()), dto.dishName(), dto.quantity(),
                                                dto.price()))
                                .toList();
                ...
                if (command.discountPara() != null) {
                        discount = Optional.of(new FullReductionDiscount(
                                        command.discountPara().threshold(),
                                        command.discountPara().amount()));
                }

                Order order = new Order(userId, merchantId, items, deliveryInfo, command.remark(), discount);
                ...
                return new CreateOrderResult(
                                ...
                                new CreateOrderResult.PricingDto(
                                                ...
                                                new CreateOrderResult.DiscountInfoDto(
